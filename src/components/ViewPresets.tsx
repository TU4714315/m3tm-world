...
const PRESETS: ViewPreset[] = [
  { label: 'العالم', lat: 20, lng: 0, zoom: 2.5, icon: '🌍' },
  { label: 'أوروبا', lat: 48, lng: 10, zoom: 4, icon: '🇪🇺' },
  { label: 'الشرق الأوسط', lat: 30, lng: 45, zoom: 4.5, icon: '🔥', hot: true },
  { label: 'شرق آسيا', lat: 35, lng: 120, zoom: 4, icon: '🌏' },
  { label: 'الأمريكيتان', lat: 25, lng: -90, zoom: 3, icon: '🌎' },
  { label: 'أوكرانيا', lat: 49, lng: 32, zoom: 6, icon: '⚔️', hot: true },
  { label: 'أفريقيا', lat: 5, lng: 20, zoom: 3.5, icon: '🌍' },
  { label: 'جنوب شرق آسيا', lat: 10, lng: 110, zoom: 4.5, icon: '🌏' },
  { label: 'القطب الشمالي', lat: 75, lng: 0, zoom: 3.5, icon: '❄️' },
  { label: 'الهند', lat: 22, lng: 78, zoom: 4.5, icon: '🇮🇳' },
  { label: 'أستراليا', lat: -25, lng: 134, zoom: 4, icon: '🇦🇺' },
  { label: 'السودان', lat: 15, lng: 30, zoom: 5.5, icon: '⚠️', hot: true },
];
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="hud-text text-[11px] text-[var(--text-primary)] tracking-widest">نطاقات العرض</span>
        <span className="gotham-tag gotham-tag--critical" style={{ fontSize: '9px', padding: '1px 4px', marginLeft: 'auto' }}>
          {PRESETS.filter(p => p.hot).length} نشطة
        </span>
      </div>
